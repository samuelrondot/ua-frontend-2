...
const tabSliderImages = [
    {
        key: "build",
        src: "/assets/bulkenrichment.gif",
    },
    {
        key: "refine",
        src: "/assets/domainsearch.gif",
    },
    {
        key: "work",
        src: "/assets/chrome.gif",
    },
    {
        key: "report",
        src: "/assets/exportlist.png",
    },
];
                    ...
                    <div className="rounded-[20px] overflow-hidden flex flex-col items-center pt-[36px] px-[40px] card-light-shadow bg-background-light-primary">
                        <div className="z-10 flex flex-row gap-24px w-full pb-64px max-w-[1076px]">
                            <button className="relative flex flex-col flex-1 gap-8px overflow-hidden rounded-12px transition-all duration-[140ms] transform"
                               ...
                               Upload your file, and let useArtemis seamlessly enrich it with emails and phone numbers.
                                </div>
                            </button>
                            <button className="relative flex flex-col flex-1 gap-8px overflow-hidden rounded-12px transition-all duration-[140ms] transform"
                                ...
                                Seamlessly find professional email addresses behind domain names.
                                </div>
                            </button>
                            <button className="relative flex flex-col flex-1 gap-8px overflow-hidden rounded-12px transition-all duration-[140ms] transform"
                                ...
                                Reveal contact informations of leads while browsing their LinkedIn profiles.
                                </div>
                            ...
                            <button className="relative flex flex-col flex-1 gap-8px overflow-hidden rounded-12px transition-all duration-[140ms] transform"
                                ...
                                Extract LinkedIn & Sales Navigator search results and get your lists enriched.                            
                                </div>
                            </button>
                        </div>
                                    ...
                                    <div className="self-center mx-auto">
                                        <div className="relative isolate">
                                            <picture className="opacity-0 absolute z-10 inset-0 w-full h-full">
                                                ...
                                                <source
                                                    srcSet="/assets/bulkenrichment.gif"
                                    ...
                                    <div className="self-center mx-auto">
                                        <div className="relative isolate">
                                            <picture className="opacity-0 absolute z-10 inset-0 w-full h-full">
                                                <source srcSet="https://attio.com" media="(min-width:992px)" />
                                                <source
                                                    srcSet="/assets/domainsearch.gif"
                                                    media="(max-width:991px)"
                                                    type="image/webp"
                                                />
                                                <img
